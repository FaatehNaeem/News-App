            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        url = "/api/news?country=".concat(props.country, "&category=").concat(props.category, "&page=").concat(page, "&pageSize=").concat(props.pageSize);
                        setLoading(true);
                        return [
                            4,
                            fetch(url)
...
function Home() {
    var pageSize = 12;
    var apiKey = ("TURBOPACK compile-time value", "7f14f429d1a24ef184f329a1c8bda3c3"); // Note: NEXT_PUBLIC prefix
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05381de5._.js.map